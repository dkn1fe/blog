...
import { registration } from "../../../app/providers/StoreProvider/config/AuthSlice.ts";
                ...
                <div className="rounded-xl bg-white shadow-2xl">
                    <div className="p-6 sm:p-16">
                        <div className="space-y-4">
                            ...
                            <h2 className="mb-8 text-2xl text-cyan-900 font-bold">Sign in to unlock the <br /> best of Meta<span className='font-bold'>Blog</span></h2>
                        </div>
